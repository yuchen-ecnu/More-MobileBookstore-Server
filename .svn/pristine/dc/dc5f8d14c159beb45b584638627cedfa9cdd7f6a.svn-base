    ...
    BootstrapTable.prototype.updatePagination = function() {
        ...
        html.push(
            ...
            '<div class="pull-right">',
                '<ul class="pagination">',
                    '<li class="page-first"><a class="btn btn-default" href="javascript:void(0)">&lt;&lt;</a></li>',
                    '<li class="page-pre"><a class="btn btn-default" href="javascript:void(0)">&lt;</a></li>');
        ...
        html.push(
                    '<li class="page-next"><a class="btn btn-default" href="javascript:void(0)">&gt;</a></li>',
                    '<li class="page-last"><a class="btn btn-default" href="javascript:void(0)">&gt;&gt;</a></li>',
                '</ul>',
            '</div>');
